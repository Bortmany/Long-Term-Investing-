 ...
 * can ask without itself contributing to the bucket. This is the same
 * "peek, don't count" pattern used by outcome-based login limiters
 * elsewhere: check first, only register a hit on a failed attempt.
 */
